  ...
  return (
    <section className="h-auto  grid grid-cols-2">
      ...
      <div className="col-span-2 mt-[1.5rem] px-5">
        <div className="mb-5">
        <h3 className="text-[34px] font-[600] mb-2 ">
          That sums it up
        </h3>
        ...
        <div className="accorfion-container mt-2">
          <div className="mt-5">
            <h4
              onClick={() =>
                set_show_accordion((prev) => ({ ...prev, first: !prev.first }))
              }
              className="font-[700] text-xl w-full  mb-3"
            >
            ...
            {show_accordion.first === true && (
              <div>
                ...
                nobis fugiat sint aut sed consequatur, temporibus nisi nostrum
                eveniet placeat quod incidunt distinctio asperiores, repellendus
                reprehenderit mollitia minus quia earum adipisci minima! Facere
                rerum alias sint nemo temporibus nam consequuntur dolore modi et
                magnam laboriosam possimus quidem at deleniti dolorum unde
                distinctio amet, nostrum voluptatum ducimus omnis. Similique
                molestias ipsum quas odit ratione iste cumque, temporibus, et
                qui dolor vitae enim minima exercitationem deserunt omnis vero
                blanditiis deleniti veritatis magni accusantium repellat
                nesciunt, molestiae quia dolores. Officiis repellendus voluptas
                quam. Fugit tenetur nam laboriosam saepe autem veritatis
                deleniti corrupti neque.
              </div>
            )}
            </div>
            <div className="mt-5">
