    ...
    <section className='p-5 h-auto'>
        <div className="shadow-lg border-2 shadow-gray-400/60 h-full rounded-lg">
            <div className='p-5 h-[45%]  flex flex-col gap-4'>
                ...
                <span className="text-gray-400 italic text-[15px]">What could your loan payments look like</span>
                <input type="text" placeholder='Where do you live ?' className='border border-gray-50 p-3 h-[50px] w-full bg-transparent rounded-lg ' />
            </div>

            <div>
            <div className="shadow-lg border-b-50 py-5 px-3 shadow-slate-400/50 w-11/12 mx-auto rounded-2xl">
